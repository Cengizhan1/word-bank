...
import com.word.bank.backend.user.dto.userContactPermission.UserContactPermissionDto;
import com.word.bank.backend.user.dto.userContactPermission.UserContactPermissionRequest;
import com.word.bank.backend.user.model.User;
import com.word.bank.backend.user.model.UserContactPermission;
import com.word.bank.backend.user.repository.UserContactPermissionRepository;
